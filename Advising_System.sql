...
insert into 
	...
	( 'Grace', 'Brown', 3.7, 'Engineering', 'grace.brown@example.com', 'IET', 'passwordghi', 0, 6, 160, 34, 6);
	...
	INSERT INTO Exam_Student VALUES
	(1, 1, 1),
	(1, 2, 1),
	(1, 3, 1), 
	(2, 2, 1),
	...
	insert into payment values(1,100000, '2024/03/01', '2024/06/30', 2, 0 ,50.00, 1, 'S24')
	...
	(1, 500, '2023-11-22', 3, 'notPaid', 50.00, 1, 'W23', '2023-12-22'),
	(2, 700, '2023-11-23', 4, 'notPaid', 60.00, 2, 'S23', '2023-12-23'),
	(3, 600, '2023-11-24', 2, 'notPaid', 40.00, 3, 'S23R1', '2023-12-24'),
	(4, 800, '2023-11-25', 3, 'notPaid', 70.00, 4, 'S23R2', '2023-12-25'),
	(5, 550, '2023-11-26', 4, 'notPaid', 45.00, 5, 'F23', '2023-12-26'),
	(6, 900, '2023-11-27', 2, 'notPaid', 80.00, 6, 'W24', '2023-12-27'),
	(7, 750, '2023-11-28', 3, 'Paid', 65.00, 7, 'S24', '2023-12-28'),
	(8, 620, '2023-11-29', 4, 'Paid', 55.00, 8, 'S24R1', '2023-12-29'),
	(9, 720, '2023-11-30', 2, 'notPaid', 75.00, 9, 'S24R2', '2023-12-30'),
	(10, 580, '2023-12-01', 3, 'Paid', 47.00, 10, 'F24', '2023-12-31');
...
CREATE PROC [Procedures_StudentRegistration]
    ...
    update Student
	set financial_status= 1 where financial_status is null;
...
Go
declare @success bit
set @success= dbo.FN_StudentLogin(1,'password123')
print @success
go
SELECT dbo.FN_StudentLogin(1, 'password123') AS success
----------------------------------------------------------------------------------------
...
exec Procedures_StudentRegisterFirstMakeup 1, 1, 'S24'
